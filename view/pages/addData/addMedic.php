...
<!-- Subject: View to add medicament
-->
...
<div id="userModal" class="modal fade">
    <div class="modal-dialog">
        <form action="index.php?controller=medic&action=formAjax" method="post" id="user_form"
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" id="name" name="name" placeholder="médicament" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" language="javascript" src="resources/js/addMedicTable.js"></script>