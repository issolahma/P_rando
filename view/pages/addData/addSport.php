...
<!-- Subject: View to add sport
-->

<div class="container box">
    <div class="table-responsive">
        <div class="box-header">
            <h3 class="box-title">Liste des sports</h3>
        </div>
        <div align="right">
...
<div id="userModal" class="modal fade">
    <div class="modal-dialog">
        <form action="index.php?controller=sport&action=formAjax" method="post" id="user_form"
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" id="name" name="name" placeholder="sport" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" language="javascript" src="resources/js/addSportTable.js"></script>