...
<div id="userModal" class="modal fade">
    <div class="modal-dialog">
        <form action="index.php?controller=season&action=formAjax" method="post" id="user_form"
...
<script type="text/javascript" language="javascript" src="resources/js/addSeasonTable.js"></script>